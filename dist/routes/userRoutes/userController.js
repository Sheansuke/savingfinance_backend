...
var addNewCategorie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, body, User;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _id = req.query._id;
                body = req.body;
                return [4 /*yield*/, UserModel_1.UserModel.findByIdAndUpdate(_id, { $addToSet: { categories: body } })];
            case 1:
                _a.sent();
                return [4 /*yield*/, UserModel_1.UserModel.findById(_id)];
            case 2:
...
exports.addNewCategorie = addNewCategorie;
