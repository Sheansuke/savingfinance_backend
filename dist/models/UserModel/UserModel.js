...
var TransactionModel_1 = require("../TransactionModel/TransactionModel");
...
exports.UserSchema.methods.encryptPassword = function (password) { return __awaiter(void 0, void 0, void 0, function () {
    var salt, encryptPassword;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1.genSalt(10)];
            case 1:
                salt = _a.sent();
                encryptPassword = bcrypt_1.hash(password, salt);
                return [2 /*return*/, encryptPassword];
        }
    });
}); };
